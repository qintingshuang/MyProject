package com.qintingshuang.base.lambda;
...
public class BaseLambda {
    ...
    /**
     * qintingshuang.base.lambda  实现runnable 接口
     */
    @Test
    public void lambdaRunnable() {
        ...
        new Thread(() -> log.info("test qintingshuang.base.lambda")).start();
        ...
        Runnable runnable1 = () -> log.info("test qintingshuang.base.lambda runnable");
        runnable1.run();
    }

    /**
     * qintingshuang.base.lambda 排序
     */
    @Test
